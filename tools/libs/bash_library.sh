...
function EnsureExists {
   ...
   if [ ! $MOD "$2" ]; then
      Error "$1 '$2' does not exist, and it is required for GBTelera framework to work propperly. $3" 121
   elif [ ! -r "$2" ]; then
...
check GBTelera installation is okay and this file is in its place and has \
